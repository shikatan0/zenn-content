...
:::details 実装メモ
- `.line` は `.editor` などで絞り込む (not `page-list-item .line`)
- `.page-link` は `[type="link"]` で絞り込む (not ハッシュタグ)
:::
