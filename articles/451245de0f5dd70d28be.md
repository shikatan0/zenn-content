...
[Windows.Media.Ocr [↗]](https://docs.microsoft.com/en-us/uwp/api/windows.media.ocr)[^1] は、画像からテキストを読み取る光学文字認識 (OCR: Optical character recognition) を行う Windows Runtime API です。
